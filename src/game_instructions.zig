...
pub fn GetInstructionMap() !std.AutoHashMap(u8, Instruction) {
    ...
    try instruction_map.put(0x18, Instruction{ .in_type = InstructionType.JR, .mode = AddressMode.N16, .cond = ConditionType.NONE });
    ...
    //0x2
    try instruction_map.put(0x20, Instruction{ .in_type = InstructionType.JR, .mode = AddressMode.N16, .cond = ConditionType.NZ });
    ...
    try instruction_map.put(0x28, Instruction{ .in_type = InstructionType.JR, .mode = AddressMode.N16, .cond = ConditionType.Z });
    ...
    //0x3
    try instruction_map.put(0x30, Instruction{ .in_type = InstructionType.JR, .mode = AddressMode.N16, .cond = ConditionType.NC });
    ...
    try instruction_map.put(0x38, Instruction{ .in_type = InstructionType.JR, .mode = AddressMode.N16, .cond = ConditionType.C });
